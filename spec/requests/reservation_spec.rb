...
RSpec.describe Api::V1::ReservationsController, type: :controller do
  ...
  let(:car) { Car.create(name: 'Test Car', description: 'Car Description', price: 10000, manufacturer: 'Manufacturer', image: 'car_image.jpg') }
  ...
  describe 'GET #index' do
    ...
    it 'includes cars in the response' do
      sign_in user
      reservation = Reservation.create(date: Date.today, city: 'Test City', user: user, car: car)
      get :index
    ...
    it 'returns reservations only for the current user' do
        ...
        other_reservation = Reservation.create(date: Date.today, city: 'Other City', user: other_user, car: car)
  ...
  describe 'POST #create' do
    ...
    it 'does not allow creating a reservation for another user' do
        ...
        expect do
          post :create, params: { reservation: { date: Date.today, city: 'Test City', user_id: other_user.id, car_id: car.id } }
